...
ActiveRecord::Schema.define(version: 2020_07_04_041202) do
  ...
  create_table "hiked_mountains", force: :cascade do |t|
    ...
    t.index ["mountain_id"], name: "index_hiked_mountains_on_mountain_id"
    t.index ["user_id"], name: "index_hiked_mountains_on_user_id"
  end
